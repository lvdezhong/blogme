module.exports = {
  ...
  language: 'ch-EN',                        // (* Required) html lang, ex. 'en' | 'en-US' | 'ko' | 'ko-KR' | ...
  siteUrl: 'https://lvdezhong.github.io',   // (* Required)
    // ex.'https://junhobaik.github.io'
    // ex.'https://junhobaik.github.io/' << X, Do not enter "/" at the end.

  /** Header */
  profileImageFileName: 'avatar.png', // include filename extension ex.'profile.jpg'
    // The Profile image file is located at path "./images/"
    // If the file does not exist, it is replaced by a random image.

  /** Home > Bio information*/
  comment: '一个喜欢音乐、游戏的前端',
  name: 'dezhonl',
  company: '',
  location: 'HangZhou',
  email: '',
  website: 'https://github.com/lvdezhong',                               // ex.'https://junhobaik.github.io'
